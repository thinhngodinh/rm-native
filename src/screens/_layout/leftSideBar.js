                    ...
                    <ImageBackground
                        ...
                        <Row style={{ justifyContent: 'space-around' }}>
                            <Col size={7} style={{padding: 5}}>
                                ...
                                {props.user && <Text style={{ color: '#737373', fontSize: 13, fontWeight: '100' }}>{props.user.email}</Text>}
                                {props.user && <Text style={{ color: '#737373', fontSize: 13 }}> ID #{props.user.id}</Text>}
                            </Col>
